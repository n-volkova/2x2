<template>
    <div class="stretch">
        <slot v-if="gameVisible" name="progress"></slot>
        <logo-screen v-show="preload" game="ff" @startGame="startGame" />

        <div v-show="!preload && gameVisible" class="ff-game" @click="popupVisible && hidePopup(arguments[0])">
            ...
            <transition name="fade">
                <div v-if="bottomVisible" class="bottom-controls">
                    ...
                    <div class="text">Доберитесь Чупиком до ЖЭКа при помощи стрелочек.</div>
                    <div class="controls">
                        <div 
