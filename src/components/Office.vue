<template>
    <div class="stretch">
        ...
        <logo-screen v-show="preload" game="office" @startGame="startGame" />

        <div v-show="!preload" class="office-game" @click="popupVisible && hidePopup(arguments[0])">
            ...
            <div class="no-overflow">
                ...
                <transition name="fade">
                    <div v-if="uvolVisible" class="uvol"></div>
                </transition>
            </div>
            ...
            <transition name="fade">
                <div v-if="bottomVisible" class="bottom-controls">
                    ...
                    <div class="text">Стрелки для ходьбы, кнопка для битья</div>
                    <div class="controls">
                        <div 
